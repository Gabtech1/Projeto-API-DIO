...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Gabriel";
    private static final String CONTACT_GITHUB = "https://github.com/Gabtech1";
    private static final String CONTACT_EMAIL = "Gabriel.telx@gmail.com";
